...
const boton = document.getElementById('fetch-btn'); //buscar en html elemento con id fetch-btn

// TODO: Selecciona el párrafo del texto ('quote-text') y asígnalo a una variable const
const textoConsejo = document.getElementById('quote-text');// busca en html el elemento con id quote-text
...
const obtenerConsejo = async () => {
    try {
        ...
        // TODO: const consejo = ...
        const consejo = data.slip.adivce;
